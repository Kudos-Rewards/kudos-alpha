...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kudos-alpha " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kudos-alphatools.com", "dnsseed.kudos-alphatools.com"},
    {"kudos-alphapool.org", "dnsseed.kudos-alphapool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"kudos-alphatools.com", "testnet-seed.kudos-alphatools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kudos-alpha is probably already running."), addrBind.ToString().c_str());
        else
